            ...
            <div className="flex flex-col">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="group flex items-center justify-center w-10 h-10 rounded-full bg-[#1877F2] hover:bg-[#166FE5] transition-all duration-300 hover:scale-110 shadow-lg relative"
                  style={{
                    boxShadow: '0 0 8px rgba(255, 255, 255, 0.3), 0 0 16px rgba(255, 255, 255, 0.2)',
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center justify-center w-10 h-10 rounded-full bg-[#25D366] hover:bg-[#22C55E] transition-all duration-300 hover:scale-110 shadow-lg relative"
                  style={{
                    boxShadow: '0 0 8px rgba(255, 255, 255, 0.3), 0 0 16px rgba(255, 255, 255, 0.2)',
                    filter: 'drop-shadow(0 0 4px rgba(255, 255, 255, 0.4))'
                  }}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center justify-center w-10 h-10 rounded-full bg-black hover:bg-gray-800 transition-all duration-300 hover:scale-110 shadow-lg border border-white/20 relative"
                  style={{
                    boxShadow: '0 0 8px rgba(255, 255, 255, 0.3), 0 0 16px rgba(255, 255, 255, 0.2)',
                    filter: 'drop-shadow(0 0 4px rgba(255, 255, 255, 0.4))'
                  }}
                ...
                <a
                  href="https://www.instagram.com/ctvetgh/?hl=en"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-400 hover:to-pink-400 transition-all duration-300 hover:scale-110 shadow-lg relative"
                  style={{
                    boxShadow: '0 0 8px rgba(255, 255, 255, 0.3), 0 0 16px rgba(255, 255, 255, 0.2)',
                    filter: 'drop-shadow(0 0 4px rgba(255, 255, 255, 0.4))'
                  }}
                >
                  ...
                  <span className="sr-only">CTVET Instagram</span>
                  {/* Subtle white glow effect */}
                  <div className="absolute inset-0 rounded-full bg-white/5 animate-pulse"></div>
                </a>
              </div>
