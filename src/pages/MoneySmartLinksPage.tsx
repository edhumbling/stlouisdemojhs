...
const MoneySmartLinksPage: React.FC = () => {
  ...
  const resourceCategories = {
    ...
    "🎥 Ghana YouTube Financial Educators": [
      {
        id: 'wode-maya-africa-economy',
        title: 'Wode Maya - Why Africa is Poor (Financial Education)',
        description: 'Deep dive into African economic challenges and financial literacy',
      ...
      {
        id: 'wode-maya-ghana-economy',
        title: 'Wode Maya - Ghana Economy Explained',
        description: 'Understanding Ghana\'s economic structure and opportunities',
      ...
      {
        id: 'kwadwo-sheldon-money-mindset',
        title: 'Kwadwo Sheldon - Money Mindset for Ghanaian Youth',
        description: 'Changing your relationship with money and building wealth',
      ...
      {
        id: 'kwadwo-sheldon-business-tips',
        title: 'Kwadwo Sheldon - Starting a Business in Ghana',
        description: 'Practical advice for young entrepreneurs in Ghana',
      ...
      {
        id: 'zionfelix-investment-basics',
        title: 'ZionFelix - Investment Basics for Ghanaians',
        description: 'Simple investment strategies for beginners in Ghana',
      ...
      {
        id: 'ghana-web-mobile-money',
        title: 'GhanaWeb - Mobile Money Security Tips',
        description: 'How to safely use mobile money services in Ghana',
      ...
      {
        id: 'ghana-web-banking-guide',
        title: 'GhanaWeb - Youth Banking Guide',
        description: 'Complete guide to banking services for young Ghanaians',
      ...
      {
        id: 'citi-tv-financial-literacy',
        title: 'Citi TV - Financial Literacy for Students',
        description: 'Essential financial skills every Ghanaian student should know',
      ...
      {
        id: 'citi-tv-entrepreneurship',
        title: 'Citi TV - Young Entrepreneurs Success Stories',
        description: 'Inspiring stories of successful young Ghanaian entrepreneurs',
      ...
      {
        id: 'joy-business-investment',
        title: 'Joy Business - Stock Market Basics Ghana',
        description: 'Introduction to investing in the Ghana Stock Exchange',
      ...
      {
        id: 'joy-business-savings',
        title: 'Joy Business - Smart Saving Strategies',
        description: 'Effective saving techniques for Ghanaian youth',
      ...
      {
        id: 'tv3-ghana-budgeting',
        title: 'TV3 Ghana - Budgeting for Young Adults',
        description: 'How to create and stick to a budget as a young Ghanaian',
      ...
      {
        id: 'tv3-ghana-digital-payments',
        title: 'TV3 Ghana - Digital Payments Revolution',
      ...
      {
        id: 'adom-tv-financial-planning',
        title: 'Adom TV - Financial Planning for Youth',
        description: 'Long-term financial planning strategies for young Ghanaians',
      ...
      {
        id: 'adom-tv-business-funding',
        title: 'Adom TV - How to Fund Your Business in Ghana',
        description: 'Various funding options for Ghanaian entrepreneurs',
      ...
      {
        id: 'gse-investment-education',
        title: 'Ghana Stock Exchange - Investment Education Series',
        description: 'Official GSE educational content on stock market investing',
      ...
      {
        id: 'gse-youth-investor',
        title: 'Ghana Stock Exchange - Youth Investor Program',
        description: 'Special program designed for young investors in Ghana',
      ...
      {
        id: 'bog-monetary-policy',
        title: 'Bank of Ghana - Understanding Monetary Policy',
        description: 'How central bank policies affect your personal finances',
      ...
      {
        id: 'bog-financial-inclusion',
        title: 'Bank of Ghana - Financial Inclusion Initiative',
        description: 'Promoting financial access for all Ghanaians',
      ...
      {
        id: 'ghana-fintech-innovation',
        title: 'Ghana FinTech - Innovation in Digital Finance',
        description: 'Latest innovations in Ghana\'s financial technology sector',
      ...
      {
        id: 'mtn-mobile-money-tutorial',
        title: 'MTN Mobile Money - Complete Tutorial for Beginners',
        description: 'Step-by-step guide to using MTN MoMo services in Ghana',
      ...
      {
        id: 'vodafone-cash-guide',
        title: 'Vodafone Cash - How to Send and Receive Money',
        description: 'Complete guide to Vodafone Cash mobile money services',
        url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#E60000',
      ...
      {
        id: 'airtel-money-tutorial',
        title: 'AirtelTigo Money - Digital Payment Made Easy',
        description: 'Learn how to use AirtelTigo Money for daily transactions',
        url: 'https://www.youtube.com/watch?v=2Vv-BfVoq4g',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
      ...
      {
        id: 'gcb-bank-youth-account',
        title: 'GCB Bank - Opening Your First Youth Account',
        description: 'How to open and manage a youth account with GCB Bank',
        url: 'https://www.youtube.com/watch?v=jNQXAC9IVRw',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
      ...
      {
        id: 'fidelity-bank-savings',
        title: 'Fidelity Bank - Smart Savings for Students',
        description: 'Student-friendly savings products and financial tips',
        url: 'https://www.youtube.com/watch?v=Me-VhC9ieh0',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
      ...
      {
        id: 'ecobank-digital-banking',
        title: 'Ecobank Ghana - Digital Banking for Youth',
        description: 'How to use Ecobank\'s digital banking services effectively',
        url: 'https://www.youtube.com/watch?v=y6120QOlsfU',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
      ...
      {
        id: 'stanbic-investment-guide',
        title: 'Stanbic Bank - Investment Guide for Beginners',
        description: 'Introduction to investment products for young Ghanaians',
        url: 'https://www.youtube.com/watch?v=kJQP7kiw5Fk',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
      ...
      {
        id: 'absa-financial-planning',
        title: 'Absa Bank - Financial Planning Workshop',
        description: 'Comprehensive financial planning for young professionals',
        url: 'https://www.youtube.com/watch?v=lAhg_P_U2qc',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
      ...
      {
        id: 'cal-bank-business-loans',
        title: 'CAL Bank - Small Business Loans for Youth',
        description: 'How to access business funding for young entrepreneurs',
        url: 'https://www.youtube.com/watch?v=fJ9rUzIMcZQ',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#006B3C',
      ...
      {
        id: 'uba-ghana-forex',
        title: 'UBA Ghana - Understanding Foreign Exchange',
        description: 'Basics of foreign exchange for Ghanaian businesses',
        url: 'https://www.youtube.com/watch?v=Lrj2Hq7xqQ8',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
      ...
      {
        id: 'access-bank-credit-cards',
        title: 'Access Bank - Credit Cards for Young Professionals',
        description: 'How to responsibly use credit cards in Ghana',
        url: 'https://www.youtube.com/watch?v=Sv3xVOs7_No',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
      ...
      {
        id: 'zenith-bank-insurance',
        title: 'Zenith Bank - Insurance Products for Youth',
        description: 'Understanding insurance and protection for young people',
        url: 'https://www.youtube.com/watch?v=hFZFjoX2cGg',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
      ...
      {
        id: 'prudential-bank-mortgages',
        title: 'Prudential Bank - First-Time Home Buyer Guide',
        description: 'Mortgage options and home buying tips for young Ghanaians',
        url: 'https://www.youtube.com/watch?v=uHgt8giw1LY',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
      ...
      {
        id: 'republic-bank-treasury-bills',
        title: 'Republic Bank - Treasury Bills Investment Guide',
        description: 'How to invest in government treasury bills in Ghana',
        url: 'https://www.youtube.com/watch?v=iik25wqIuFo',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
      ...
      {
        id: 'gse-stock-trading',
        title: 'Ghana Stock Exchange - How to Trade Stocks',
        description: 'Complete guide to buying and selling stocks on GSE',
        url: 'https://www.youtube.com/watch?v=bFEoMO0pc7k',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FCD116',
      ...
      {
        id: 'gse-dividend-investing',
        title: 'Ghana Stock Exchange - Dividend Investing Strategy',
        description: 'How to build wealth through dividend-paying stocks',
        url: 'https://www.youtube.com/watch?v=5jFHPfV_Ztw',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FCD116',
      ...
      {
        id: 'gse-market-analysis',
        title: 'Ghana Stock Exchange - Market Analysis for Beginners',
        description: 'Understanding market trends and stock analysis',
        url: 'https://www.youtube.com/watch?v=QH2-TGUlwu4',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FCD116',
      ...
      {
        id: 'bog-inflation-impact',
        title: 'Bank of Ghana - How Inflation Affects Your Money',
        description: 'Understanding inflation and protecting your purchasing power',
        url: 'https://www.youtube.com/watch?v=nfWlot6h_JM',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
      ...
      {
        id: 'bog-currency-exchange',
        title: 'Bank of Ghana - Currency Exchange Basics',
        description: 'Understanding exchange rates and currency conversion',
        url: 'https://www.youtube.com/watch?v=ktvTqknDobU',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
      ...
      {
        id: 'bog-financial-stability',
        title: 'Bank of Ghana - Financial Stability and You',
        description: 'How central bank policies affect personal finances',
        url: 'https://www.youtube.com/watch?v=Ks7_cIzPZSU',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
      ...
      {
        id: 'hubtel-payment-solutions',
        title: 'Hubtel - Complete Payment Solutions Guide',
        description: 'How to use Hubtel for business and personal payments',
        url: 'https://www.youtube.com/watch?v=xuCn8ux2gbs',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
      ...
      {
        id: 'paystack-ghana-setup',
        title: 'Paystack Ghana - Setting Up Online Payments',
        description: 'Complete guide to accepting online payments with Paystack',
        url: 'https://www.youtube.com/watch?v=4Hx_oQwrNuY',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
      ...
      {
        id: 'flutterwave-ghana-tutorial',
        title: 'Flutterwave Ghana - Payment Integration Tutorial',
        description: 'How to integrate Flutterwave payments for your business',
        url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
      ...
      {
        id: 'zeepay-remittances',
        title: 'Zeepay - International Money Transfer Guide',
        description: 'How to send and receive money internationally with Zeepay',
        url: 'https://www.youtube.com/watch?v=2Vv-BfVoq4g',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
      ...
      {
        id: 'expresspay-bill-payments',
        title: 'ExpressPay - Bill Payment Made Simple',
        description: 'Pay your utilities and bills easily with ExpressPay',
        url: 'https://www.youtube.com/watch?v=jNQXAC9IVRw',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
      ...
      {
        id: 'slydepay-merchant-guide',
        title: 'SlydePay - Merchant Payment Solutions',
        description: 'How businesses can accept payments with SlydePay',
        url: 'https://www.youtube.com/watch?v=Me-VhC9ieh0',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
      ...
      {
        id: 'mazzuma-wallet-setup',
        title: 'Mazzuma - Digital Wallet Setup Guide',
        description: 'Complete guide to setting up and using Mazzuma wallet',
        url: 'https://www.youtube.com/watch?v=y6120QOlsfU',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
      ...
      {
        id: 'interswitch-pos-systems',
        title: 'Interswitch - POS Systems for Small Business',
        description: 'How to set up point-of-sale systems for your business',
        url: 'https://www.youtube.com/watch?v=kJQP7kiw5Fk',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
      ...
      },
      {
        ...
        title: 'GhIPSS - Instant Payment System Tutorial',
        description: 'Understanding Ghana\'s national instant payment system',
        url: 'https://www.youtube.com/watch?v=lAhg_P_U2qc',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
      ...
      {
        id: 'ghana-microfinance-loans',
        title: 'Ghana Microfinance - Small Loans for Entrepreneurs',
        description: 'How to access microfinance loans for your business',
        url: 'https://www.youtube.com/watch?v=fJ9rUzIMcZQ',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FCD116',
      ...
      {
        id: 'rural-banks-community-banking',
        title: 'Rural Banks Ghana - Community Banking Services',
        description: 'How rural banks serve local communities in Ghana',
        url: 'https://www.youtube.com/watch?v=Lrj2Hq7xqQ8',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#006B3C',
      ...
      {
        id: 'credit-unions-cooperative-banking',
        title: 'Credit Unions Ghana - Cooperative Banking Benefits',
        description: 'Understanding credit unions and cooperative banking',
        url: 'https://www.youtube.com/watch?v=Sv3xVOs7_No',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
      ...
      },
      {
        ...
        title: 'NPRA Ghana - Pension Planning for Young Workers',
        description: 'How to plan for retirement as a young Ghanaian worker',
        url: 'https://www.youtube.com/watch?v=hFZFjoX2cGg',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
      ...
      },
      {
        ...
        title: 'Ghana Insurance - Types of Insurance for Youth',
        description: 'Essential insurance products every young person needs',
        url: 'https://www.youtube.com/watch?v=uHgt8giw1LY',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
      ...
      {
        id: 'ghana-tax-basics',
        title: 'Ghana Revenue Authority - Tax Basics for Youth',
        description: 'Understanding your tax obligations as a young Ghanaian',
        url: 'https://www.youtube.com/watch?v=iik25wqIuFo',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
      ...
      {
        id: 'ghana-business-registration',
        title: 'Registrar General - Business Registration Guide',
        description: 'How to register your business in Ghana step-by-step',
        url: 'https://www.youtube.com/watch?v=bFEoMO0pc7k',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FCD116',
      ...
      {
        id: 'ghana-import-export-finance',
        title: 'Ghana Trade - Import/Export Financing Guide',
        description: 'How to finance import and export businesses in Ghana',
        url: 'https://www.youtube.com/watch?v=5jFHPfV_Ztw',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#006B3C',
      ...
      {
        id: 'ghana-agriculture-finance',
        title: 'Agricultural Development Bank - Farm Financing',
        description: 'Financial services for young farmers and agribusiness',
        url: 'https://www.youtube.com/watch?v=QH2-TGUlwu4',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
      ...
      },
      {
        ...
        title: 'Ghana Real Estate - Investment Guide for Youth',
        description: 'How to invest in real estate as a young Ghanaian',
        url: 'https://www.youtube.com/watch?v=nfWlot6h_JM',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
      ...
      },
      {
        ...
        title: 'Ghana Crypto - Cryptocurrency Basics and Regulations',
        description: 'Understanding cryptocurrency and regulations in Ghana',
        url: 'https://www.youtube.com/watch?v=ktvTqknDobU',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
      ...
      {
        id: 'ghana-forex-trading',
        title: 'Ghana Forex - Foreign Exchange Trading Guide',
        description: 'Introduction to forex trading for Ghanaian investors',
        url: 'https://www.youtube.com/watch?v=Ks7_cIzPZSU',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
      ...
      {
        id: 'ghana-commodity-trading',
        title: 'Ghana Commodity Exchange - Trading Basics',
        description: 'How to trade commodities on Ghana Commodity Exchange',
        url: 'https://www.youtube.com/watch?v=xuCn8ux2gbs',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FCD116',
      ...
      {
        id: 'ghana-bond-market',
        title: 'Ghana Bond Market - Government Securities Guide',
        description: 'How to invest in government bonds and securities',
        url: 'https://www.youtube.com/watch?v=4Hx_oQwrNuY',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
      ...
      {
        id: 'ghana-mutual-funds',
        title: 'Ghana Mutual Funds - Investment for Beginners',
        description: 'Understanding mutual funds and unit trusts in Ghana',
        url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
      ...
      {
        id: 'ghana-venture-capital',
        title: 'Ghana Venture Capital - Startup Funding Guide',
        description: 'How to access venture capital for your startup in Ghana',
        url: 'https://www.youtube.com/watch?v=2Vv-BfVoq4g',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
      ...
      },
      {
        ...
        title: 'Ghana Angel Network - Finding Angel Investors',
        description: 'How to connect with angel investors in Ghana',
        url: 'https://www.youtube.com/watch?v=jNQXAC9IVRw',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
      ...
      {
        id: 'ghana-crowdfunding',
        title: 'Ghana Crowdfunding - Alternative Funding Methods',
        description: 'Using crowdfunding platforms to raise money in Ghana',
        url: 'https://www.youtube.com/watch?v=Me-VhC9ieh0',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
      ...
      {
        id: 'ghana-financial-planning-youth',
        title: 'Ghana Financial Planning - Life Goals for Youth',
        description: 'Creating a comprehensive financial plan as a young Ghanaian',
        url: 'https://www.youtube.com/watch?v=y6120QOlsfU',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
      ...
      {
        id: 'ghana-emergency-fund',
        title: 'Ghana Emergency Fund - Building Financial Security',
        description: 'How to build an emergency fund in the Ghanaian context',
        url: 'https://www.youtube.com/watch?v=kJQP7kiw5Fk',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
      ...
      {
        id: 'ghana-debt-management',
        title: 'Ghana Debt Management - Getting Out of Debt',
        description: 'Strategies for managing and eliminating debt in Ghana',
        url: 'https://www.youtube.com/watch?v=lAhg_P_U2qc',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
