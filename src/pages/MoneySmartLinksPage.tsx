...
const MoneySmartLinksPage: React.FC = () => {
  ...
  const resourceCategories = {
    ...
    "🎥 Ghana YouTube Financial Educators": [
      {
        id: 'ghana-financial-basics-101',
        title: 'Financial Literacy 101 - Ghana Edition',
        description: 'Complete beginner guide to personal finance in Ghana',
      ...
      {
        id: 'mtn-momo-tutorial-complete',
        title: 'MTN Mobile Money Complete Tutorial',
        description: 'Step-by-step guide to using MTN MoMo in Ghana',
      ...
      {
        id: 'vodafone-cash-tutorial',
        title: 'Vodafone Cash - How to Send Money',
        description: 'Complete guide to Vodafone Cash mobile money',
      ...
      {
        id: 'airtel-money-guide',
        title: 'AirtelTigo Money Tutorial',
        description: 'How to use AirtelTigo Money for transactions',
      ...
      {
        id: 'ghana-banking-basics',
        title: 'Banking in Ghana - Youth Guide',
        description: 'How to open and manage bank accounts in Ghana',
      ...
      {
        id: 'ghana-savings-tips',
        title: 'Smart Saving Tips for Ghanaian Youth',
        description: 'Practical money saving strategies in Ghana',
      ...
      {
        id: 'ghana-budgeting-guide',
        title: 'Budgeting Made Simple - Ghana Edition',
        description: 'How to create a budget that works in Ghana',
      ...
      {
        id: 'gse-investment-basics',
        title: 'Ghana Stock Exchange - Investment Basics',
        description: 'Introduction to investing on the Ghana Stock Exchange',
      ...
      {
        id: 'bog-financial-education',
        title: 'Bank of Ghana - Financial Education Series',
        description: 'Official financial education from Bank of Ghana',
      ...
      },
      {
        ...
        title: 'Best Investment Apps in Ghana',
        description: 'Top apps for investing and saving money in Ghana',
      ...
      },
      {
        ...
        title: 'Avoiding Financial Scams in Ghana',
        description: 'How to protect yourself from financial fraud',
      ...
      {
        id: 'ghana-student-finance',
        title: 'Student Finance Guide - Ghana',
        description: 'Managing money as a student in Ghana',
      ...
      {
        id: 'ghana-side-hustle',
        title: 'Side Hustles for Ghanaian Youth',
        description: 'Profitable side business ideas in Ghana',
      ...
      {
        id: 'ghana-digital-payments',
        title: 'Digital Payments in Ghana Explained',
        description: 'Understanding Ghana\'s digital payment ecosystem',
      ...
      {
        id: 'ghana-insurance-basics',
        title: 'Insurance Basics for Ghanaians',
        description: 'Understanding insurance products in Ghana',
      ...
      {
        id: 'ghana-tax-basics',
        title: 'Tax Basics for Young Ghanaians',
        description: 'Understanding your tax obligations in Ghana',
      ...
      {
        id: 'ghana-pension-planning',
        title: 'Pension Planning for Young Workers',
        description: 'How to plan for retirement in Ghana',
      ...
      {
        id: 'ghana-forex-basics',
        title: 'Foreign Exchange Basics - Ghana',
        description: 'Understanding forex and currency exchange',
      ...
      {
        id: 'ghana-real-estate-investment',
        title: 'Real Estate Investment in Ghana',
        description: 'How to invest in Ghanaian real estate',
      ...
      {
        id: 'ghana-credit-score-basics',
        title: 'Understanding Credit Scores in Ghana',
        description: 'How credit scoring works and how to improve your credit rating',
        url: 'https://www.youtube.com/watch?v=8HkwTaJgdaE',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-microfinance-guide',
        title: 'Microfinance in Ghana - Complete Guide',
        description: 'How to access microfinance loans for small businesses',
        url: 'https://www.youtube.com/watch?v=9KLwTaJgdaF',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-susu-savings',
        title: 'Traditional Susu Savings in Modern Ghana',
        description: 'How traditional savings groups work in contemporary Ghana',
        url: 'https://www.youtube.com/watch?v=7JkwTaJgdaG',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FCD116',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-treasury-bills-guide',
        title: 'Ghana Treasury Bills - Investment Tutorial',
        description: 'How to invest in government treasury bills for steady returns',
        url: 'https://www.youtube.com/watch?v=6IkwTaJgdaH',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-youth-entrepreneur-fund',
        title: 'Youth Entrepreneur Fund - Application Guide',
        description: 'How to apply for government youth entrepreneurship funding',
        url: 'https://www.youtube.com/watch?v=5HkwTaJgdaI',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-import-business-finance',
        title: 'Financing Your Import Business in Ghana',
        description: 'How to fund and manage an import business successfully',
        url: 'https://www.youtube.com/watch?v=4GkwTaJgdaJ',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
        level: 'Advanced' as const
      ...
      {
        id: 'ghana-financial-planning-couples',
        title: 'Financial Planning for Couples in Ghana',
        description: 'How couples can manage money and plan finances together',
        url: 'https://www.youtube.com/watch?v=3FkwTaJgdaK',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-emergency-fund-building',
        title: 'Building an Emergency Fund in Ghana',
        description: 'Step-by-step guide to creating financial security',
        url: 'https://www.youtube.com/watch?v=2EkwTaJgdaL',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-debt-consolidation',
        title: 'Debt Consolidation Strategies for Ghanaians',
        description: 'How to manage and consolidate multiple debts effectively',
        url: 'https://www.youtube.com/watch?v=1DkwTaJgdaM',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-agricultural-loans',
        title: 'Agricultural Loans in Ghana - Farmers Guide',
        description: 'How farmers can access financing for agricultural projects',
        url: 'https://www.youtube.com/watch?v=9CkwTaJgdaN',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-women-financial-empowerment',
        title: 'Financial Empowerment for Ghanaian Women',
        description: 'Special financial programs and opportunities for women',
        url: 'https://www.youtube.com/watch?v=8BkwTaJgdaO',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-retirement-planning-guide',
        title: 'Retirement Planning for Young Ghanaians',
        description: 'How to start planning for retirement in your 20s and 30s',
        url: 'https://www.youtube.com/watch?v=7AkwTaJgdaP',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-cryptocurrency-basics',
        title: 'Cryptocurrency Basics for Ghanaians',
        description: 'Understanding digital currencies and blockchain in Ghana',
        url: 'https://www.youtube.com/watch?v=6ZkwTaJgdaQ',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
        level: 'Advanced' as const
      ...
      {
        id: 'ghana-financial-literacy-children',
        title: 'Teaching Financial Literacy to Ghanaian Children',
        description: 'How parents can teach money management to kids',
        url: 'https://www.youtube.com/watch?v=5YkwTaJgdaR',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FCD116',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-business-registration-guide',
        title: 'Business Registration in Ghana - Step by Step',
        description: 'Complete guide to registering your business legally',
        url: 'https://www.youtube.com/watch?v=4XkwTaJgdaS',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-online-banking-security',
        title: 'Online Banking Security in Ghana',
        description: 'How to safely use internet banking and avoid fraud',
        url: 'https://www.youtube.com/watch?v=3WkwTaJgdaT',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-mutual-funds-investment',
        title: 'Mutual Funds Investment in Ghana',
        description: 'How to invest in mutual funds and unit trusts',
        url: 'https://www.youtube.com/watch?v=2VkwTaJgdaU',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-freelancing-taxes',
        title: 'Tax Guide for Freelancers in Ghana',
        description: 'How freelancers should handle taxes and compliance',
        url: 'https://www.youtube.com/watch?v=1UkwTaJgdaV',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-commodity-investment',
        title: 'Commodity Investment in Ghana',
        description: 'How to invest in gold, cocoa, and other commodities',
        url: 'https://www.youtube.com/watch?v=9TkwTaJgdaW',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FCD116',
        level: 'Advanced' as const
      ...
      {
        id: 'ghana-financial-goals-setting',
        title: 'Setting Financial Goals - Ghana Edition',
        description: 'How to set and achieve realistic financial objectives',
        url: 'https://www.youtube.com/watch?v=8SkwTaJgdaX',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-business-loan-application',
        title: 'How to Apply for Business Loans in Ghana',
        description: 'Complete guide to securing business financing',
        url: 'https://www.youtube.com/watch?v=7RkwTaJgdaY',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-money-transfer-services',
        title: 'International Money Transfer Services in Ghana',
        description: 'Best ways to send and receive money internationally',
        url: 'https://www.youtube.com/watch?v=6QkwTaJgdaZ',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-investment-portfolio',
        title: 'Building an Investment Portfolio in Ghana',
        description: 'How to diversify investments for better returns',
        url: 'https://www.youtube.com/watch?v=5PkwTaJgda1',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
        level: 'Advanced' as const
      ...
      {
        id: 'ghana-financial-mistakes-avoid',
        title: '10 Financial Mistakes Ghanaians Should Avoid',
        description: 'Common money mistakes and how to prevent them',
        url: 'https://www.youtube.com/watch?v=4OkwTaJgda2',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-salary-negotiation',
        title: 'Salary Negotiation Tips for Ghanaians',
        description: 'How to negotiate better salaries and benefits in Ghana',
        url: 'https://www.youtube.com/watch?v=3NkwTaJgda3',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-financial-independence',
        title: 'Achieving Financial Independence in Ghana',
        description: 'Roadmap to financial freedom for young Ghanaians',
        url: 'https://www.youtube.com/watch?v=2MkwTaJgda4',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
        level: 'Advanced' as const
      ...
      {
        id: 'ghana-passive-income-ideas',
        title: 'Passive Income Ideas for Ghanaians',
        description: 'Ways to generate income without active work',
        url: 'https://www.youtube.com/watch?v=1LkwTaJgda5',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-financial-apps-review',
        title: 'Best Financial Apps for Ghanaians - Review',
        description: 'Comprehensive review of top financial management apps',
        url: 'https://www.youtube.com/watch?v=9KkwTaJgda6',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-estate-planning',
        title: 'Estate Planning for Young Ghanaians',
        description: 'How to plan your estate and protect your assets',
        url: 'https://www.youtube.com/watch?v=8JkwTaJgda7',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
        level: 'Advanced' as const
      ...
      {
        id: 'ghana-financial-stress-management',
        title: 'Managing Financial Stress in Ghana',
        description: 'How to cope with money-related stress and anxiety',
        url: 'https://www.youtube.com/watch?v=7IkwTaJgda8',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-investment-clubs',
        title: 'Starting Investment Clubs in Ghana',
        description: 'How to form and manage investment groups with friends',
        url: 'https://www.youtube.com/watch?v=6HkwTaJgda9',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-financial-education-resources',
        title: 'Free Financial Education Resources in Ghana',
        description: 'Where to find quality financial education materials',
        url: 'https://www.youtube.com/watch?v=5GkwTaJgda0',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FCD116',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-business-valuation',
        title: 'Business Valuation Basics for Ghanaians',
        description: 'How to value your business for investment or sale',
        url: 'https://www.youtube.com/watch?v=4FkwTaJgdaA',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
        level: 'Advanced' as const
      ...
      {
        id: 'ghana-financial-literacy-workplace',
        title: 'Financial Literacy in the Workplace - Ghana',
        description: 'Workplace financial wellness programs and benefits',
        url: 'https://www.youtube.com/watch?v=3EkwTaJgdaB',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-inflation-protection',
        title: 'Protecting Your Money from Inflation in Ghana',
        description: 'Investment strategies to beat inflation',
        url: 'https://www.youtube.com/watch?v=2DkwTaJgdaC',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-financial-mentorship',
        title: 'Finding Financial Mentors in Ghana',
        description: 'How to find and work with financial mentors',
        url: 'https://www.youtube.com/watch?v=1CkwTaJgdaD',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-side-business-ideas',
        title: 'Profitable Side Business Ideas for Ghana',
        description: 'Low-cost business ideas you can start today',
        url: 'https://www.youtube.com/watch?v=9BkwTaJgdaE',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-financial-technology-trends',
        title: 'FinTech Trends in Ghana - What to Watch',
        description: 'Latest financial technology developments in Ghana',
        url: 'https://www.youtube.com/watch?v=8AkwTaJgdaF',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-money-mindset',
        title: 'Developing a Wealth Mindset in Ghana',
        description: 'Changing your relationship with money for success',
        url: 'https://www.youtube.com/watch?v=7ZkwTaJgdaG',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-international-investment',
        title: 'International Investment Opportunities for Ghanaians',
        description: 'How to invest in global markets from Ghana',
        url: 'https://www.youtube.com/watch?v=6YkwTaJgdaH',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
        level: 'Advanced' as const
      ...
      {
        id: 'ghana-financial-planning-families',
        title: 'Family Financial Planning in Ghana',
        description: 'How families can plan finances together effectively',
        url: 'https://www.youtube.com/watch?v=5XkwTaJgdaI',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-economic-indicators',
        title: 'Understanding Ghana Economic Indicators',
        description: 'How economic data affects your personal finances',
        url: 'https://www.youtube.com/watch?v=4WkwTaJgdaJ',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#CE1126',
        level: 'Advanced' as const
      ...
      {
        id: 'ghana-financial-recovery',
        title: 'Financial Recovery After Crisis - Ghana Guide',
        description: 'How to rebuild finances after financial setbacks',
        url: 'https://www.youtube.com/watch?v=3VkwTaJgdaK',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF0000',
        level: 'Intermediate' as const
      ...
      {
        id: 'ghana-youth-financial-challenges',
        title: 'Financial Challenges Facing Ghanaian Youth',
        description: 'Common financial obstacles and how to overcome them',
        url: 'https://www.youtube.com/watch?v=2UkwTaJgdaL',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FF6B35',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-sustainable-investing',
        title: 'Sustainable Investing in Ghana',
        description: 'ESG investing and socially responsible investments',
        url: 'https://www.youtube.com/watch?v=1TkwTaJgdaM',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#059669',
        level: 'Advanced' as const
      ...
      {
        id: 'ghana-financial-habits',
        title: 'Building Good Financial Habits in Ghana',
        description: 'Daily habits that lead to financial success',
        url: 'https://www.youtube.com/watch?v=9SkwTaJgdaN',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#8B5CF6',
        level: 'Beginner' as const
      ...
      {
        id: 'ghana-financial-freedom-roadmap',
        title: 'Financial Freedom Roadmap for Ghanaians',
        description: 'Step-by-step plan to achieve financial independence',
        url: 'https://www.youtube.com/watch?v=8RkwTaJgdaO',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#FCD116',
        level: 'Advanced' as const
      ...
      {
        id: 'ghana-money-management-tools',
        title: 'Money Management Tools for Ghanaians',
        description: 'Best tools and apps for managing your finances',
        url: 'https://www.youtube.com/watch?v=7QkwTaJgdaP',
        category: 'YouTube Ghana Finance',
        icon: <Video className="w-4 h-4" />,
        color: '#0066CC',
        level: 'Beginner' as const
