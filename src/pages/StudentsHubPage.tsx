...
const StudentsHubPage: React.FC = () => {
  ...
  const resourceCategories = {
    ...
    "🎵 Lofi Playlists for Study/Focused Learning": [
      ...
      {
        id: 1010,
        title: "Trappin in Japan 1",
        description: "Ryan Celsius - Japanese-inspired trap lofi beats",
        url: "https://www.youtube.com/watch?v=Q7wZ3t9Ck2g",
        icon: <Music className="w-5 h-5" />,
        color: "#F8C471",
        isYouTube: true
      },
      {
        id: 1011,
        title: "Trappin in Japan 2",
        description: "Ryan Celsius - Japanese-inspired trap lofi beats vol 2",
        url: "https://www.youtube.com/watch?v=5k0dF4e5C9I",
        icon: <Music className="w-5 h-5" />,
        color: "#82E0AA",
        isYouTube: true
      },
      {
        id: 1012,
        title: "Trappin in Japan 3",
        description: "Ryan Celsius - Japanese-inspired trap lofi beats vol 3",
        url: "https://www.youtube.com/watch?v=6z1G3zFz1Zc",
        icon: <Music className="w-5 h-5" />,
        color: "#D7BDE2",
        isYouTube: true
      },
      {
        id: 1013,
        title: "Trappin in Japan 4",
        description: "Ryan Celsius - Japanese-inspired trap lofi beats vol 4",
        url: "https://www.youtube.com/watch?v=7d5jv0lYv2E",
        icon: <Music className="w-5 h-5" />,
        color: "#85C1E9",
        isYouTube: true
      },
      {
        id: 1014,
        title: "Trappin in Japan 5",
        description: "Ryan Celsius - Japanese-inspired trap lofi beats vol 5",
        url: "https://www.youtube.com/watch?v=8e6Z3vFz1Zc",
        icon: <Music className="w-5 h-5" />,
        color: "#A9CCE3",
        isYouTube: true
      },
      {
        id: 1015,
        title: "Trappin in Japan 6",
        description: "Ryan Celsius - Japanese-inspired trap lofi beats vol 6",
        url: "https://www.youtube.com/watch?v=9f7Z3t9Ck2g",
        icon: <Music className="w-5 h-5" />,
        color: "#F9E79F",
        isYouTube: true
      },
      {
        id: 1016,
        title: "Trappin in Japan 7",
        description: "Ryan Celsius - Japanese-inspired trap lofi beats vol 7",
        url: "https://www.youtube.com/watch?v=10gZ3t9Ck2g",
        icon: <Music className="w-5 h-5" />,
        color: "#ABEBC6",
        isYouTube: true
      },
      {
        id: 1017,
        title: "Trappin in Japan 8",
        description: "Ryan Celsius - Japanese-inspired trap lofi beats vol 8",
        url: "https://www.youtube.com/watch?v=11hZ3t9Ck2g",
        icon: <Music className="w-5 h-5" />,
        color: "#D5A6BD",
        isYouTube: true
      },
      {
        id: 1018,
        title: "Trappin in Japan 9",
        description: "Ryan Celsius - Japanese-inspired trap lofi beats vol 9",
        url: "https://www.youtube.com/watch?v=12iZ3t9Ck2g",
        icon: <Music className="w-5 h-5" />,
        color: "#D1ECF1",
        isYouTube: true
      },
      {
        id: 1019,
        title: "Trappin in Japan 10",
        description: "Ryan Celsius - Japanese-inspired trap lofi beats vol 10",
        url: "https://www.youtube.com/watch?v=13jZ3t9Ck2g",
        icon: <Music className="w-5 h-5" />,
        color: "#E8DAEF",
        isYouTube: true
      },
