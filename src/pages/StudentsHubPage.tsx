...
const StudentsHubPage: React.FC = () => {
  ...
  const resources: Resource[] = [
    {
      id: 1,
      title: "Audiobooks",
      description: "Free audiobooks collection with thousands of free ebooks",
      url: "https://marhamilresearch4.blob.core.windows.net/gutenberg-public/Website/browse.html",
      icon: <Mic className="w-5 h-5" />,
      color: "#007AFF",
      keywords: ["books", "reading", "literature", "stories", "audio", "listen", "gutenberg", "free books", "classic literature", "novels", "fiction"]
    },
    {
      id: 2,
      ...
      color: "#FF3B30",
      keywords: ["poems", "rhymes", "literature", "english", "reading", "writing", "verse", "poetry", "children's literature"]
    },
    {
      id: 3,
      title: "BECE PASCO",
      ...
      color: "#34C759",
      keywords: ["exams", "tests", "study", "practice", "questions", "answers", "basic education", "past papers", "BECE", "examination"]
    },
    {
      id: 11,
      title: "BECE Pasco 2",
      ...
      customScripts: true,
      keywords: ["exams", "tests", "study", "practice", "questions", "answers", "basic education", "solutions", "past papers", "BECE", "examination"]
    },
    {
      id: 12,
      ...
      color: "#FF9500",
      isUSSD: true,
      keywords: ["exams", "mobile", "phone", "sms", "ussd", "offline", "text", "basic education", "past papers", "BECE"]
    },
    {
      id: 4,
      title: "JHS MOCKS",
      ...
      icon: <FileText className="w-5 h-5" />,
      color: "#FF9500",
      keywords: ["exams", "tests", "study", "practice", "questions", "answers", "junior high", "mock exams", "preparation", "assessment"]
    },
    {
      id: 5,
      title: "QWEN Maths",
      ...
      color: "#5856D6",
      keywords: ["mathematics", "calculator", "problem solving", "equations", "algebra", "geometry", "arithmetic", "AI", "math help", "solutions"]
    },
    {
      id: 6,
      ...
      color: "#AF52DE",
      keywords: ["language", "translation", "twi", "ga", "ewe", "hausa", "dagbani", "akan", "ghanaian languages", "translate", "communication"]
    },
    {
      id: 7,
      ...
      color: "#FF6B35",
      isInternal: true,
      keywords: ["motivation", "inspiration", "success", "career", "leadership", "speeches", "advice", "life lessons", "wisdom", "guidance"]
    },
    {
      id: 8,
      ...
      keywords: ["money", "finance", "savings", "budget", "investing", "banking", "money smarts", "economics", "personal finance", "credit", "debt", "financial planning", "wealth", "loans", "khan academy", "financial education"]
    },
    {
      id: 9,
      ...
      keywords: ["business", "entrepreneurship", "management", "leadership", "startup", "marketing", "sales", "career", "strategy", "AI chat", "professional skills"]
    },
    {
      id: 10,
      ...
      color: "#F59E0B",
      keywords: ["innovation", "product", "design", "development", "creativity", "entrepreneurship", "ideas", "startup", "AI chat", "product management", "ideation"]
    },
  ];
  ...
  const displayResources = debouncedSearchTerm ? filteredResources : resources;
