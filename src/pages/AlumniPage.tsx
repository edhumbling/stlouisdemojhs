    ...
    <div className="min-h-screen bg-black">
      ...
      <section id="stories" className="py-6 sm:py-8 md:py-12 relative overflow-hidden">
        ...
        <div className="w-full px-3 sm:px-4 relative z-10">
          ...
          >
            <div className="glass-card rounded-xl p-4 sm:p-6 shadow-lg border border-green-400/30 bg-green-500/10">
              <div className="text-center">
                <div className="w-16 h-16 bg-green-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">✨</span>
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-white mb-3">
                  Add Your Alumni Success Story on This Wall
                </h3>
                <p className="text-gray-300 text-sm sm:text-base mb-4 leading-relaxed">
                  Share your achievements, career milestones, and how St. Louis Demo JHS shaped your journey.
                  Your story could inspire current students and fellow alumni.
                </p>
                <div className="bg-white/10 rounded-lg p-4 mb-4">
                  <p className="text-white font-semibold mb-2">📱 Submit Your Story</p>
                  <p className="text-gray-300 text-sm mb-3">
                    Reach out to Emmanuel via WhatsApp:
                    <span className="font-bold text-green-400 ml-1">0208705290</span>
                  </p>
                  <p className="text-gray-400 text-xs">
                    Stories will be reviewed and placed accordingly on our alumni wall
                  </p>
                </div>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center px-4 py-2 sm:px-6 sm:py-3 bg-green-600 hover:bg-green-700 text-white text-sm sm:text-base font-bold rounded-lg sm:rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                >
                ...
                <p className="text-gray-400 text-xs mt-3">
                  We're looking forward to filling this wall with 100s of success stories!
                </p>
              </div>
            </div>
          </motion.div>
